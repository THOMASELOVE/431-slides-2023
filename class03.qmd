...
format:
  revealjs: 
    ...
    footer: "431 Class 03 | 2023-09-05 | <https://thomaselove.github.io/431-2023/>"
---
...
These slides walk through everything in that Quarto document, and we'll use the same slides in Class 03 that we use in Class 04, so we can go a bit slowly through things.

## Today's Files

From our [431-data page](https://github.com/THOMASELOVE/431-data), or our [Class 03 README (data folder)](https://github.com/THOMASELOVE/431-classes-2023/tree/main/class03/data), you should find:

- `431-first-r-template.qmd`
- `quick_survey_2023.csv`
...
- The most important package is actually a series of packages called the `tidyverse`, which we'll use in every Quarto file we create this semester. 
    - The `tidyverse` includes several packages, all developed (in part) by Hadley Wickham, Chief Scientist at Posit (makers of RStudio).
...
Our data come from the Quick 15-item Survey we did in Class 02 ([pdf in Class 02 README](https://github.com/THOMASELOVE/431-classes-2023/blob/main/class02/431_surveyhandout_1perstudent_2023-08-31.pdf)), which we've done (in various forms) since 2014. 

- A copy of these data (in .csv format) is on our [431-data page](https://github.com/THOMASELOVE/431-data), and also linked on our [Class 03 README](https://github.com/THOMASELOVE/431-classes-2023/tree/main/class03/data).
...
#| echo: true
quicksur_raw <- 
  read_csv("c03/data/quick_survey_2023.csv", show_col_types = FALSE) |>
  clean_names()
```

- Note the `<-` assignment arrow to create `quicksur_raw`
- Here, we use `read_csv` to read in data from the `c03/data` subfolder of my R project directory which contains the `quick_survey_2023.csv` file from our [431-data page](https://github.com/THOMASELOVE/431-data).
